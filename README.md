...
Для запуска сбора статистики по каждому виду из исследуемых задач, можно запустить непосредственно необходимый модуль, указав количество вызовов для сбора статистики, необходимость отображения графика статистики на экране, необходимость сохранения графика статистики в файл
[logo]: resources/request_site_asinc_import.png "Logo text"
Также можно импортировать модуль целиком в Ваш проект и запускать функцию runner() с необходимыми параметрами
[logo]: resources/request_site_asinc.png "Logo text"
